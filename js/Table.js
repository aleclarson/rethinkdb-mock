...
var Query, Table, assertType, clearTable, define, findRow, getRow, getRows, insertRows, isArray, isConstructor, methods, parseArgs, runQuery, setProto, sliceArray, utils, uuid;
...
"nth bracket getField offsetsOf contains orderBy filter fold count limit slice merge pluck without update".split(" ").forEach(function(key) {

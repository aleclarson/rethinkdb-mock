...
var DELETE, Datum, GET, GET_ALL, INSERT, Selection, Sequence, Table, assertType, clearTable, findRow, getRow, getRows, i, insertRows, isArray, isConstructor, methods, setType, sliceArray, utils, uuid;
...
methods.get = function(rowId) {
  return Selection(Table(this._db, this._tableId, [GET, rowId]));
};
...
getRow = function(table, rowId, context) {
  var index;
  if (rowId === void 0) {
